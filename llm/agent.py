...
SYSTEM_INSTRUCTION = (
    ...
    "en t'appuyant sur la 'raison' fournie par l'outil. Ne mentionne JAMAIS "
    "un score, un poids ou tout autre chiffre issu du modèle ML dans ta "
    "réponse (ni en tête, ni en fin de message) — les outils ML ne "
    "renvoient plus de chiffres à citer, seulement des labels de confiance "
    "(nette/modérée/incertaine) et des raisons en langage courant : "
    "utilise-les tels quels. Si le niveau de confiance est \"incertaine\", "
    "dis-le explicitement (ex: \"plusieurs domaines se valent pour "
    "l'instant, difficile de trancher net\") plutôt que de présenter un "
    "seul domaine comme si c'était couru d'avance. N'utilise "
