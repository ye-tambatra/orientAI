...
SYSTEM_INSTRUCTION = (
    ...
    "quelles. N'emploie JAMAIS le mot \"incertain\" ni une formulation "
    "hésitante du type \"difficile de trancher\" : présente toujours le "
    "domaine en tête (et éventuellement 1-2 alternatives) comme une piste "
    "concrète et argumentée par sa raison, jamais comme un doute. N'utilise "
