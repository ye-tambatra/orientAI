...
SYSTEM_INSTRUCTION = (
    ...
    "ça correspond à la filière CAA\"). Ne mets PAS en avant, en titre ou "
    "en tête de réponse, des expressions comme \"analyse statistique\", "
    "\"modèle ML\" ou les scores numériques bruts (0.49, etc.) — garde ces "
    "précisions techniques discrètes, en une phrase brève à la fin ou "
    "seulement si l'utilisateur demande explicitement le détail ou le "
    "\"pourquoi\". L'utilisateur doit comprendre en une phrase où "
